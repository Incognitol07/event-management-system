...
INSERT INTO "new_events" ("capacity", "category", "createdAt", "createdById", "date", "department", "description", "endTime", "id", "isApproved", "memo", "priority", "startTime", "title", "updatedAt", "venueId") SELECT "capacity", "category", "createdAt", "createdById", "date", "department", "description", "endTime", "id", "isApproved", "memo", "priority", "startTime", "title", "updatedAt", "venueId" FROM "events";
DROP TABLE "events";
